...
export function normalizeModel(raw, provider, options = {}) {
...
function normalizeContext(raw, fallback) {
...
function buildCapabilityFlags(capabilityTags, toolSupport) {
    const hasTag = (tag) => capabilityTags.includes(tag);
    return {
...
//# sourceMappingURL=normalizeModel.js.map