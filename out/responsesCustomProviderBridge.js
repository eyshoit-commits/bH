...
export function extractChatCompletionTextContent(content) {
...
export function buildResponsesCustomProviderChatPayload(payload, rawModelId, defaultSystemPrompt) {
    const messages = [];
...
export function mapChatCompletionToResponsesApiResponse(payload, exposedModel, response, createdAt = Math.floor(Date.now() / 1000)) {
...
//# sourceMappingURL=responsesCustomProviderBridge.js.map