import type { ModelCapabilities, NormalizedModel } from './normalizeModel.js';

export function mergeModels(autoModels: NormalizedModel[], manualModels: NormalizedModel[]): NormalizedModel[] {
	const mergedMap = new Map<string, NormalizedModel>();
...
function mergeCapabilities(a: ModelCapabilities, b: ModelCapabilities): ModelCapabilities {
	return {
